                ...
                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-xxs-12 col-xs-6 mt">
                                        <div class="input-field">
                                            ...
                                            <input type="text" class="form-control" id="from-place" placeholder="Cambodia"/>
                                        </div>
                                    </div>
                                    <div class="col-xxs-12 col-xs-6 mt">
                                        <div class="input-field">
                                            <label for="from">To:</label>
                                            <input type="text" class="form-control" id="to-place" placeholder="Siem Reap"/>
                                        </div>
                                    </div>
                                 ...
                                 <div class="row">
                                    <div class="col-xxs-12 col-xs-12 mt">
                                        <div class="input-field">
                                            ...
                                            <input type="text" class="form-control" id="from-place" placeholder="Siem Reap"/>
                                        </div>
                                    </div>
                                    <div class="col-xxs-12 col-xs-6 mt alternate">
                                        <div class="input-field">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-xxs-12 col-xs-6 mt">
                                        <div class="input-field">
                                            ...
                                            <input type="text" class="form-control" id="to-place" placeholder="Cambodia"/>
                                        </div>
                                    </div>
                                    <div class="col-xxs-12 col-xs-6 mt alternate">
                                        <div class="input-field">
                    ...
                    <div class="desc2 animate-box">
                        <div class="col-sm-7 col-sm-push-1 col-md-7 col-md-push-1">
                            <h2>Welcome to Tov-Nah</h2>
                            <h3>Promotion for Christmas</h3>
